...
class LabPointProvider {
    toInt(point) {
        ...
        var xyz = [
            (fx3 > e ? fx3 : (116 * fx - 16) / kappa) * utils.WHITE_POINT_D65[0],
            (8 < l ? fy * fy * fy : l / kappa) * utils.WHITE_POINT_D65[1],
            (fz3 > e ? fz3 : (116 * fz - 16) / kappa) * utils.WHITE_POINT_D65[2]
        ];
        return utils.intFromXyzComponents(xyz[0], xyz[1], xyz[2]);
    }
    distance(from, to) {
