...
class TonalGroups {
  TonalGroup? primary;
  TonalGroup? secondary;
  TonalGroup? tertiary;
  TonalGroup? neutral;
  TonalGroup? neutralVariant;
  TonalGroup? error;
...
class ThemeAdapterBase {
  ...
  MonetColorScheme get light {
    final overrides = props.isBaseline
        ? BASELINE_3P.light
        : props.overrides.light ?? MonetColorScheme();
    final p = palettes;
  ...
  MonetColorScheme get dark {
    final overrides = props.isBaseline
        ? BASELINE_3P.dark
        : props.overrides.dark ?? MonetColorScheme();
    final p = palettes;
    return MonetColorScheme(
